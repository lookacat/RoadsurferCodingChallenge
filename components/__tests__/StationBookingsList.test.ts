...
describe("StationBookingsList.vue", () => {
  ...
  // Helper function to mount component with consistent setup
  const mountComponent = () => {
    return mount(StationBookingsList);
  };
  ...
  describe("Component Template Logic", () => {
    test("should have proper conditional rendering logic for no station", () => {
      ...
      const shouldShowInfoAlert =
        !wrapper.vm.stationsStore.selectedStation &&
        !wrapper.vm.stationsStore.loading;
