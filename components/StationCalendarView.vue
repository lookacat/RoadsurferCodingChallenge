<template>
  <v-container>
    ...
    <BookingDetailsModal
      ...
      :station-id="selectedBookingStationId"
...
const selectedBookingStationId = ref("");

// Handle booking click from calendar
const handleBookingClick = (booking: any) => {
  selectedBookingId.value = booking.id;
  selectedBookingStationId.value = stationsStore.selectedStation?.id || "";
...
function onWeekSelect(weekValue: string) {
  if (weekValue) {
    const selectedWeek = weekOptions.value.find(
